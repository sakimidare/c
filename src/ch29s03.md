...
<div align="center">
  ...
  <img src="images/fs.vfs.png" />

  <p><b>图 29.8. VFS</b></p>

</div>

在[第 28 章 **文件与 I/O**](ch28.md#io)中讲过，每个进程在 PCB（Process Control Block）中都保存着一份文件描述符表，文件描述符就是这个表的索引，每个表项都有一个指向已打开文件的指针，现在我们明确一下：已打开的文件在内核中用 `file` 结构体表示，文件描述符表中的指针指向 `file` 结构体。
...
<div align="center">
  ...
  <img src="images/fs.dup.png" />

  <p><b>图 29.9. dup/dup2 示例程序</b></p>
